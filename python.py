...
def jfrogUpload() :
    ...
    url = 'http://3.87.183.127:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/Myapp/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Admin123' #replace 'your password with ur actual password'
